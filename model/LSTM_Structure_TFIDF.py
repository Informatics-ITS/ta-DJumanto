...
class LSTM_Structure_TFIDF:
    ...
    def __build_model(self, max_length, vocab_size_structure, embedding_dim=128, lstm_units=64):
        ...
        structure_lstm = LSTM(lstm_units)(structure_embed)
    ...
    def fit(self):
        ...
        self.model.save('./h5/LSTM_Structure_TFIDF_model.h5')
        return history
    ...
    def evaluate(self, fold):
        ...
        #save outputs
        with open(f'./outputs/predictions/evaluation_metrics_LSTM_Structure_TFIDF_epoch-{self.epochs}_lemdim-{self.embedding_dim}_lstmdim-{self.lstm_units}_fold-{fold}.json', 'w') as f:
