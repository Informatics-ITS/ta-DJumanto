...
class LSTM_TFIDF:
    ...
    def fit(self):
        ...
        self.model.save('./h5/LSTM_TFIDF_model.h5')
        return history
    ...
    def evaluate(self, fold):
        ...
        #save outputs
        with open(f'./outputs/predictions/evaluation_metrics_LSTM_TFIDF_epoch-{self.epochs}_lemdim-{self.embedding_dim}_lstmdim-{self.lstm_units}_fold-{fold}.json', 'w') as f:
