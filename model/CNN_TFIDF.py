...
class CNN_TFIDF:
    ...
    def __build_model(self, max_length, vocab_size_content, vocab_size_structure, embedding_dim=128):
    ...
    def fit(self):
        ...
        self.model.save('./h5/CNN_TFIDF_model.h5')
        
        return history

    def evaluate(self, fold):
        """
        Evaluates the model on the test set and saves metrics.
        ...
        with open(f'./outputs/predictions/evaluation_metrics_CNN_TFIDF_epoch-{self.epochs}_embdim-{self.embedding_dim}_filters-{filters_str}_kernels-{kernels_str}_fold-{fold}.json', 'w') as f:
