...
class LSTM_Content_TFIDF:
    def __init__(self, train, test, validation, max_length=300, vocab_size_content=10000, vocab_size_structure=10000, embedding_dim=128, lstm_units=64, epochs=10, batch_size=32):
        """
        Initializes the AT-BiLSTM model.
        Args:
            max_length: Maximum length of input sequences.
            vocab_size_content: Vocabulary size for content input.
            vocab_size_structure: Vocabulary size for structure input.
            embedding_dim: Dimension of the embedding layer.
            lstm_units: Number of units in the LSTM layer.
            attention_size: Size of the attention context (hyperparameter).
        """
    ...
    def __build_model(self, max_length, vocab_size_content, embedding_dim=128, lstm_units=64):
        ...
        content_lstm = LSTM(lstm_units)(content_embed)
    ...
    def fit(self):
        ...
        self.model.save('./h5/LSTM_Content_TFIDF_model.h5')
        return history
    ...
    def evaluate(self, fold):
        ...
        #save outputs
        with open(f'./outputs/predictions/evaluation_metrics_LSTM_Content_TFIDF_epoch-{self.epochs}_lemdim-{self.embedding_dim}_lstmdim-{self.lstm_units}_fold-{fold}.json', 'w') as f:
